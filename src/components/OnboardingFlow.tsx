          ...
          <label className="flex items-start gap-3 cursor-pointer">
            ...
            <div className="text-left">
              <span className="text-xs text-dark font-light leading-relaxed block">
                ...
                <a href="#privacy-modal" className="text-brand font-semibold hover:underline">Privacy Policy</a> &amp;{" "}
                <a href="#terms-modal" className="text-brand font-semibold hover:underline">Terms of Enrollment</a>.
              </span>
            </div>
          </label>
        </div>
      ...
      <footer className="mt-16 border-t border-brand/5 pt-12 px-6 md:px-12 max-w-7xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-[10px] font-mono text-muted border-t border-brand/5 pt-6">
          <div className="flex flex-wrap gap-4">
            <a href="#privacy-modal" className="hover:text-brand transition-colors">Privacy Policy</a>
            <a href="#terms-modal" className="hover:text-brand transition-colors">Terms &amp; Guidelines</a>
          </div>
          <div>
